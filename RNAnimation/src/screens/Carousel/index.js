...
const DATA = [
    {
        key: 0,
        image: require("../../assets/images/Carousel/image0.jpg"),
        title: "BEAR DEV",
        subtitle: "Delivered by BEAR DEV",
    ...
    {
        key: 6,
        image: require("../../assets/images/Carousel/image6.jpg"),
        title: "React Native",
        subtitle: "Delivered by BEAR DEV",
        price: Math.floor(Math.random() * (200 - 80 + 1) + 80),
    },
    {
        key: 7,
        image: require("../../assets/images/Carousel/image7.jpg"),
        title: "Flutter",
        subtitle: "Delivered by BEAR DEV",
        price: Math.floor(Math.random() * (200 - 80 + 1) + 80),
    },
    {
        key: 8,
        image: require("../../assets/images/Carousel/image8.jpg"),
        title: "Swift",
        subtitle: "Delivered by BEAR DEV",
        price: Math.floor(Math.random() * (200 - 80 + 1) + 80),
    },
    {
        key: 9,
        image: require("../../assets/images/Carousel/image9.jpg"),
        title: "JavaScript",
        subtitle: "Delivered by BEAR DEV",
        price: Math.floor(Math.random() * (200 - 80 + 1) + 80),
    },
    {
        key: 10,
        image: require("../../assets/images/Carousel/image10.jpg"),
        title: "Is The Best",
        subtitle: "Delivered by BEAR DEV",
        price: Math.floor(Math.random() * (200 - 80 + 1) + 80),
    },
    {
        key: 11,
        image: require("../../assets/images/Carousel/image11.jpg"),
        title: "Android",
        subtitle: "Delivered by BEAR DEV",
        price: Math.floor(Math.random() * (200 - 80 + 1) + 80),
    },
    {
        key: 12,
        image: require("../../assets/images/Carousel/image12.jpg"),
        title: "Head Phone",
        subtitle: "Delivered by BEAR DEV",
        price: Math.floor(Math.random() * (200 - 80 + 1) + 80),
    },
    {
        key: 13,
        image: require("../../assets/images/Carousel/image13.jpg"),
        title: "Carousel",
        subtitle: "Delivered by BEAR DEV",
        price: Math.floor(Math.random() * (200 - 80 + 1) + 80),
    },
    {
        key: 14,
        image: require("../../assets/images/Carousel/image14.jpg"),
        title: "Tiny PC",
        subtitle: "Delivered by BEAR DEV",
        price: Math.floor(Math.random() * (200 - 80 + 1) + 80),
    },
    ...
    return (
        <SafeAreaView style={{ backgroundColor: '#A5F1FA', flex: 1 }}>
            ...
            <View style={{
                ...
                <Text style={{textTransform:'uppercase', fontSize:22, fontWeight: '500'}}>Bear     DEV</Text>
